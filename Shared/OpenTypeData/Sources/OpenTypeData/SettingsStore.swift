...
public class SettingsStore: ObservableObject {
    ...
    // MARK: - Whisper.cpp
    @Published public var whisperModelPath: String? {
        didSet { defaults.set(whisperModelPath, forKey: "whisperModelPath") }
    }

    @Published public var whisperBinaryPath: String? {
        didSet { defaults.set(whisperBinaryPath, forKey: "whisperBinaryPath") }
    }
    ...
    private init() {
        ...
        whisperBinaryPath = defaults.string(forKey: "whisperBinaryPath")
